//namespace Playing_Card_Poker_Game; // C# groups things in name spaces
package PlayingCard; // Java groups things in packages - package name must match the folder name for the package
...
//                            datatype  variable-name    = initial-value  ;
     ...
     *
     * C#: a private variable starts with an underscore, by convention
    ...
    /***************************************************************************************************
     * Only C# has Properties - Used for others to access private data via getters and setters
     * Java does not support properties -
     * Jave requires specefic getter and setter methods for each variable
     **************************************************************************************************/
